...
## 📝 Details
- **Categories**: [Maps & Geo](https://github.com/tools-collection/apis-collection#maps--geo-), [Weather](https://github.com/tools-collection/apis-collection#weather-), [Environment & Nature](https://github.com/tools-collection/apis-collection#environment--nature-)
- **Type**: `REST`
- **Auth**: `none`
- **Free**: `No`
- **Status**: `Graveyard` 🪦
