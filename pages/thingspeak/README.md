...
## 🧰 Libraries
### 🛠️ ThingSpeak Python SDK by Chris Lee
- **Platform**: `Python`
- **Docs**: [📚 Documentation](https://github.com/sirleech/thingspeak)


- **Author**: 👤 sirleech
- **Stars**: ⭐ 20
### 🛠️ ThingSpeak Ruby SDK by ThingSpeak
- **Platform**: `Ruby`
- **Docs**: [📚 Documentation](https://github.com/iobridge/thingspeak)
