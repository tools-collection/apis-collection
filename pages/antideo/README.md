...
## 🧰 Libraries
### 🛠️ Antideo Objective-C SDK by Antideo
- **Platform**: `Objective-C`
- **Docs**: [📚 Documentation](https://github.com/antideo/xcode)



- **Stars**: ⭐ 2
### 🛠️ Antideo PHP Library by Antideo
- **Platform**: `PHP`
- **Docs**: [📚 Documentation](https://www.antideo.com)
- **Source**: [💻 Source Code](https://github.com/antideo/PHP)
