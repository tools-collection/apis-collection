# 📦 [Telleroo](https://docs.telleroo.com/)
...
## 📝 Details
- **Categories**: [Payments](https://github.com/tools-collection/apis-collection#payments-), [Business](https://github.com/tools-collection/apis-collection#business-)
- **Type**: `N/A`
- **Auth**: `none`
- **Free**: `No`
- **Status**: `Graveyard` 🪦
